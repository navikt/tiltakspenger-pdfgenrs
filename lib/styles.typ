...
#let apply-styles(body) = {
    ...
    // `= tittel`-markup styles likt som mainTitle i lib/pensjonsbrev — verdiene gjentas her fordi mainTitle selv lager en heading, og et kall fra denne show-regelen ville rekursert.
